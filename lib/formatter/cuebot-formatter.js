 ...
 *
 * Cuebot - Formatter for CucumberJS
 */
"use strict";
...
class CuebotAPIFormatter extends JsonFormatter {
  constructor(options) {
    super(options);
    this.inCi = true;
    ...
    options.eventBroadcaster.on("test-run-started", () => {
      this.logFn(`${colors.green("Cuebot-mobile")} Test Run \n`);
    });
...
module.exports = CuebotAPIFormatter;
